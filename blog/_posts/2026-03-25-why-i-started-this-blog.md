...
- **Practical engineering problems** — real situations, how I diagnosed them, what worked and what didn't
- **3D modeling for engineers** — I'm learning Blender, Shapr3D, and build123d, and I want to document that journey from an engineer's perspective, not an artist's
- **Software as an engineering tool** — scripts, automation, and tools that solve real problems
- **Lessons from the field** — the kind of hard-won knowledge that only comes from hands-on experience
