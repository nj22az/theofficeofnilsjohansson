...
- [ ] Regulatory changes affecting scope of work
- [ ] New client requirements or market changes
- [ ] Changes in tools, technology, or workflows
- [ ] Changes in business scope or services offered
...
- [ ] Document creation procedure working effectively
...
- [ ] Tools and software adequate for current work
- [ ] Time allocated for documentation is sufficient
- [ ] Skills and knowledge adequate for planned work
...
- [ ] Procedures to create or revise: [List or "None"]
- [ ] Templates to create or revise: [List or "None"]
- [ ] Quality manual updates needed: [List or "None"]
