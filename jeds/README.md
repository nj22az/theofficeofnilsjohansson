...
JEDS is the in-house documentation and quality management system for all engineering work produced under The Office of Nils Johansson. It defines how documents are created, numbered, reviewed, revised, stored, and retired.
...
|---|---|
| How documents are numbered | [Document Numbering Standard](quality-manual/JEDS-QMS-001_document-numbering.md) |
...
```
JEDS-[CATEGORY]-[NUMBER]
Example: JEDS-RPT-014
```

With revision: `JEDS-RPT-014 Rev B`

Full details: [Document Numbering Standard](quality-manual/JEDS-QMS-001_document-numbering.md)
